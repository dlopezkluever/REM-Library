...
# **`phase-3-post-launch-growth-and-media-spec-dev-plan.md`**
...
**Expand the system after launch with larger-scale web crawling, media-rich entity and claim pages, source rights metadata, and the first structured community suggestion workflow.**
...
Do not invent unnecessary features. Do not overbuild. Stay focused on what the audit says belongs in Phase 3.
...
### Phase 3 Work Items to Cover

At minimum, cover the work items named in the audit’s Phase 3 section:

* Blog/site crawling
* Sitemap parsing and internal article discovery
* Admin review flow for crawled URLs
* Inline media embeds on entity and claim pages
* `InlineMediaPlayer` or equivalent media component
* Entity images
* Public `entity-images` storage bucket
* Copyright/license/source rights fields
* Community accounts
* Suggestion workflow
* `suggestions` table
* Suggestion review queue
* Approval flow that converts suggestions into draft content, not directly published content
