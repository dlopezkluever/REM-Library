...
5. Test performance target: 3D view should maintain ≥30 FPS at 5,000 nodes on a modern laptop GPU. If not, implement a node count cap (show the top 2,000 by confidence score in 3D) with a notice: "3D view shows the top 2,000 nodes by confidence. Use filters to explore a subset."
